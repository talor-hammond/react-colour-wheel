...
function produceRgbShades(r, g, b, amount) {
  var shades = [];

  var hsl = tinycolor('rgb(' + r + ', ' + g + ', ' + b + ')').toHsl();
...
function getEffectiveRadius(trueRadius, lineWidth) {
  return trueRadius - lineWidth / 2;
}

var hexStrings = ['#00C3A9', '#00B720', '#008813', '#000000', '#FFFFFF', '#F8E300', '#FF6400', '#E20000', '#AC000D', '#9E005F', '#6D0E82', '#3B3887', '#175FDA', '#0091E2', '#00BCED', '#14E4C5'];
...
var ColourWheel = function (_Component) {
  _inherits(ColourWheel, _Component);

  function ColourWheel() {
    _classCallCheck(this, ColourWheel);

    var _this = _possibleConstructorReturn(this, (ColourWheel.__proto__ || Object.getPrototypeOf(ColourWheel)).call(this));
    ...
    // Bindings:
    _this.onCanvasHover = _this.onCanvasHover.bind(_this);
  ...
  _createClass(ColourWheel, [{
    ...
    value: function getRelativeMousePos(clientX, clientY) {
      ...
      };var fromCenter = Math.sqrt((onCanvas.x - w / 2) * (onCanvas.x - w / 2) + (onCanvas.y - h / 2) * (onCanvas.y - h / 2));
    ...
    value: function componentDidMount() {
      ...
      if (this.props.preset) {
        ...
        this.setState({ rgb: rgb }, function () {
    ...
    value: function onCanvasHover(_ref) {
      ...
      var evt = this.getRelativeMousePos(clientX, clientY);
    ...
    value: function drawOuterWheel() {
      ...
      var effectiveRadius = getEffectiveRadius(radius, lineWidth);
      ...
      rgbArr.forEach(function (rgb, i) {
        ...
        _this6.ctx.strokeStyle = 'rgb(' + rgb.r + ', ' + rgb.g + ', ' + rgb.b + ')';
        _this6.ctx.stroke();
    ...
    value: function drawSpacer(spacerRadius) {
      var _props3 = this.props,
          ...
          _props3$spacers = _props3.spacers,
          colour = _props3$spacers.colour,
          shadowColour = _props3$spacers.shadowColour,
          shadowBlur = _props3$spacers.shadowBlur;
    ...
    value: function drawInnerWheel() {
      ...
      var effectiveRadius = getEffectiveRadius(this.innerWheelRadius, lineWidth);
      ...
      var rgbShades = produceRgbShades(r, g, b, shades);
      ...
      function drawShades() {
        ...
        rgbShades.forEach(function (rgb, i) {
          ...
          // Stroke style changes based on the shade:
          _this7.ctx.strokeStyle = 'rgb(' + rgb.r + ', ' + rgb.g + ', ' + rgb.b + ')';
          _this7.ctx.stroke();
      ...
      function animateShades() {
        ...
        rgbShades.forEach(function (rgb, i) {
          ...
          // Stroke style changes based on the shade:
          _this8.ctx.strokeStyle = 'rgb(' + rgb.r + ', ' + rgb.g + ', ' + rgb.b + ')';
          _this8.ctx.stroke();
    ...
    value: function render() {
      var _props5 = this.props,
          ...
          dynamicCursor = _props5.dynamicCursor;


      return dynamicCursor ? React__default.createElement('canvas', {
        id: 'colour-picker',
