...
var index = ((options = {}) => {
  ...
  return {
    ...
    onwrite(opts) {
      return new Promise(function ($return, $error) {
        var getExtracted, shouldExtract, _getExtracted, code, codeFilePath, map, mapFilePath;
        ...
        if (options.onExtract) {
          return Promise.resolve(options.onExtract(getExtracted)).then(function ($await_5) {
            try {
              shouldExtract = $await_5;
        ...
        function $If_3() {
          ...
          return Promise.resolve(fs.ensureDir(path.dirname(codeFilePath)).then(() => Promise.all([fs.writeFile(codeFilePath, code, 'utf8'), sourceMap === true && fs.writeFile(mapFilePath, map, 'utf8')]))).then(function ($await_6) {
            try {
              return $return();
            } catch ($boundEx) {
              return $error($boundEx);
